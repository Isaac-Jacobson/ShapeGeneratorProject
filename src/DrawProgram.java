...
public class DrawProgram {
	...
	/**
	 * Calls load, passing args[0] as the name of the text file containing graphics
	 * primitives. Calls draw to draw the primitives.
	 * 
		...
		try {
			...
			while (scan.hasNextLine()) {
				...
				case "CIRCLE":
					x0 = Integer.parseInt(fields[2]);
					y0 = Integer.parseInt(fields[3]);
					Circle circle = new Circle(x0, y0, Integer.parseInt(fields[4]));
